...
export default function InboxPage() {
  const { tasks, loading, completeTask, deleteTask, refreshTasks } = useTasks({ inbox: true, completed: false });
      ...
      <div className="max-w-screen-lg mx-auto">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
            <p className="text-gray-500 text-lg mb-2">Inbox zero!</p>
            <p className="text-gray-400 text-sm">All tasks are organized</p>
          </div>
        ) : (
          <TaskList
            items={tasks}
